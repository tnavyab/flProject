# ============================================================
#                MESSIDOR CLIENT (FEDPROX + SAFE CM)
# ============================================================
...
from dataset import IDRiDDataset   # Use your Messidor dataset class if different
...
CSV_PATH = r"C:\Users\tnavy\OneDrive\Documents\FL PROJECT\DATA\messidor_data.csv"
IMG_DIR  = r"C:\Users\tnavy\OneDrive\Documents\FL PROJECT\DATA\IMAGES"
...
def evaluate_model():
    ...
    dr_loss_total, dme_loss_total = 0.0, 0.0
    ...
    for imgs, dr, dme in val_loader:
        ...
        dr_loss_total += dr_loss_fn(dr_out, dr).item()
        dme_loss_total += dme_loss_fn(dme_out, dme).item()
    ...
    avg_loss = (dr_loss_total + dme_loss_total) / len(val_loader)
...
class MessidorClient(fl.client.NumPyClient):
